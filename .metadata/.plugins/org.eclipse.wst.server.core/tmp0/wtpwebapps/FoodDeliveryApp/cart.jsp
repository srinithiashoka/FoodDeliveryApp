...
<footer>
<p>© 2025 FoodHub | All Rights Reserved | Made with ❤️ </p></footer>
...
// Update cart quantity to server
function updateCartServer(menuId, quantity) {
    fetch('<%= request.getContextPath() %>/updateCart', {
        method: 'POST',
...
function confirmOrder() {
    ...
    fetch('<%= request.getContextPath() %>/confirmOrder', {
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
